...
data_ber_cond = data_ber(1:3);
data_ber_noncond = data_ber(4:end);
m = (data_ber_cond+data_ber_noncond)/2;
e1 = data_ber_cond-data_ber_noncond;
e = errorbar(1:1:3,m,e1,'o','MarkerEdgeColor','red')
e.Color = 'red';

data_cri_cond = data_cri(1:3);
data_cri_noncond = data_cri(10:end);
m = (data_cri_cond+data_cri_noncond)/2;
e2 = data_cri_cond-data_cri_noncond;
e = errorbar(1:1:3,m,e2,'o','MarkerEdgeColor','green')
e.Color = 'green';

data_dan_cond = data_dan(1:3);
data_dan_noncond = data_dan(4:end);
m = (data_dan_cond+data_dan_noncond)/2;
e3 = data_dan_cond-data_dan_noncond;
e = errorbar(1:1:3,m,e3,'o','MarkerEdgeColor','blue')
e.Color = 'blue';

data_eli_cond = data_eli(1:3);
data_eli_noncond = data_eli(4:end);
m = (data_eli_cond+data_eli_noncond)/2;
e4 = data_eli_cond-data_eli_noncond;
e = errorbar(1:1:3,m,e4,'o','MarkerEdgeColor','yellow')
e.Color = 'yellow';
